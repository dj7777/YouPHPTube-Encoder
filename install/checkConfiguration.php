...
$sql = "INSERT INTO `formats` VALUES "
        . "(1,'MP4','ffmpeg -i {\$pathFileName} -vf scale=-2:480 -vcodec h264 -acodec aac -strict -2 -y {\$destinationFile}','2017-01-01 00:00:00','2017-07-24 16:07:03','mp4','mp4'),"
        . "(2,'Webm','ffmpeg -i {\$pathFileName} -vf scale=-2:360 -f webm -c:v libvpx -b:v 1M -acodec libvorbis -y {\$destinationFile}','2017-07-11 12:56:26','2017-07-24 16:07:03','webm','mp4'),"
